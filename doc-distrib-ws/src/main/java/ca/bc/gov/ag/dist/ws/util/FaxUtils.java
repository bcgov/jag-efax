...
public class FaxUtils {
	 ...
	 * @return a formatted string Exchange Server expects to see to send faxes
	...
	/**
	 * Copies and maps request parameters to MailMessage properties.
	 * <i>Based on the logic found in DocumentDistributionMainProcess.bpel:prepareFaxMessage and SendFaxService/bpel/transformSendMessage.xsl</i>
	 */
